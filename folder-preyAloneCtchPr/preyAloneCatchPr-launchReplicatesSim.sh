...
prd_intr_1=301   # argv[28] predator 1 time of introduction in the model
...
# sim values arrays
pry2srvArray=(10 15 20)
pry2cPrArray=(0.05 0.10 0.15 0.20 0.25 0.3)
    ...
    do
        ...
        #     prd_offs_1=${predOffsArray[$m]}  
            ...
            #     divide=$((3*$prd_surv_1)); by=$freq_surv; prd_cons_1=`echo "scale=0; ($divide+$by-1)/$by" | bc`;
                ...
                sim_name="newSA-py2surv$pry_surv_2-py2cPr$prd_ctch_pry2_1" # argv[1]
